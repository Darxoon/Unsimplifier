...
const typedefs = {
	...
	[DataType.Effect]: {
		...
		field_0x40: new Property("string", "Used in aji_16"),
		field_0x48: new Property("string", "Used in bom_02"),
	},
...
The effect emitter set used when the character lands from a jump.`),
		dustEffect: new Property("string", `
The effect emitter set used when the character generates dust when walking.`),
		field_0xe8: "int",
		field_0xec: "int",
		field_0xf0: "int",
		field_0xf4: "int",
...
`),
		...
		angle: "float",
		field_0x44: "int",
		field_0x48: new Property("string", "Used in dou_11"),
		field_0x50: "int",
		field_0x54: "int",
		fadeType: "string",
		field_0x60: "string",
		field_0x68: new Property("string", "Used in hei_02"),
		field_0x70: "int",
		field_0x74: "int",
		direction: "string",
		field_0x80: "int",
	...
	[DataType.ModelAssetGroup]: {
		...
		modelFolder: "string",
		fileName: "string",
		textureName: new Property("string", "Used for loading external texture .bntx files. ex: If the filename is BOM, and the texture name is Default, then the texture.bntx file would look like BOM.Default.bntx.zst"),
		field_0x18: "int",
		field_0x1c: "int",
	},
	[DataType.ModelState]: {
...
Texture name from romfs/ui/icon/icon.bntx.zst`),
	...
	[DataType.UiMail]: {
		...
		field_0x08: "int",
		field_0x0c: "int",
		mailTo: new Property("string", `
Mail To text from mail.msbt`),
		mailFrom: new Property("string", `
Mail From text from mail.msbt`),
		mailBody: new Property("string", `
Body of the mail from mail.msbt`),
		field_0x28: "string",
		field_0x30: "int",
		field_0x34: "int",
	},
...
Map name from global.msbt`),
		mapDescription: new Property("string", `
Map description from global.msbt`),
	},
